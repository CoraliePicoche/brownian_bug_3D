...
\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.99\textwidth]{dominance_diatom_nano_compare_advection.pdf} 
\par\end{centering}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.99\textwidth]{dominance_diatom_nano_compare_advection_10sp.pdf} 
\par\end{centering}
\caption{Dominance indices as a function of distance (in cm) for microphytoplankton
...
\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.8\textwidth]{carac_10species.pdf} 
\par\end{centering}
