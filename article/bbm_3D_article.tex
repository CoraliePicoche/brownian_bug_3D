...
Fré{}dé{}ric Barraquand\textonesuperior $^{,*}${}}
\maketitle
...
$^{*}$corresponding authors: \verb|coralie.picoche@u-bordeaux.fr|
\& \verb|frederic.barraquand@u-bordeaux.fr|
...
affects the interaction structure within a community \citep{haegeman_how_2008},
and may sustain diversity.
...
computation of advection velocity $U$, shown in Section S7 of the
...
further away from other cells, due to their lower concentrations (Figure
S10 of the SI), than nanophytoplankters (2 to 20 \textmu m). However,
